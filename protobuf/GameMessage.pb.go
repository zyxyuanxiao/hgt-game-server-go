...
func (x *Test) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
var file_protos_protobuf_GameMessage_proto_rawDesc = []byte{
	...
	0x3e, 0x0a, 0x04, 0x54, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4e,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x57, 0x6f, 0x72, 0x64, 0x42,
...
var file_protos_protobuf_GameMessage_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_protos_protobuf_GameMessage_proto_goTypes = []interface{}{
	(*Message)(nil), // 0: GameMessage.Message
	(*Test)(nil),    // 1: GameMessage.Test
}
